...
import com.airport.baggagerouting.model.Edge;
import com.airport.baggagerouting.model.Graph;
import com.airport.baggagerouting.model.Vertex;
...
public class TestTravelAlgorithm extends TestCase{

	private List<Vertex> nodes;
	private List<Edge> edges;
	private Graph graph;
	private TravelAlgorithm Travel;
	...
	public void testExcute() {
		...
		Travel = new TravelAlgorithm(graph);
	...
	private void getPathDistance(Map.Entry<String,Vertex[]> bag) {
		...
		Travel.execute(vertexes[0]);
		Map<Integer,LinkedList<Vertex>> path = Travel.getPath(vertexes[1]);
